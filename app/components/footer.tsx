        ...
        <footer className="container max-w-full" ref={contactUsRef}>
                ...
                <div className="w-full md:w-[60%] xl:w-[70%] flex flex-col gap-10 font-corporate-regular font-medium">
                    ...
                    <div className="flex flex-col xl:flex-row gap-5 md:gap-2 lg:gap-5 items-center md:items-left md:justify-between text-xl md:text-lg lg:text-xl">
                        <div className="flex gap-2">
                            <Image src={`${basePath}images/icons/call-icon.svg`} alt="Call Icon" width={25} height={25} />
                            <Link href="tel:+918040453453">080-40453453</Link>
                        </div>
                        <div className="flex gap-2">
                            <Image src={`${basePath}images/icons/mail-icon.svg`} alt="Mail Icon" width={25} height={25} />
            ...
            <div className="bg-[#9f1634] flex flex-col justify-center items-center md:items-end h-15 px-20">
                <ul className="flex gap-10">
                    <li>
                        <Link href="https://www.facebook.com/centuryrealestatebangalore/" target="_blank"><Image src={`${basePath}images/icons/facebook.svg`} alt="Facebook" width={20} height={20} /></Link>
                    </li>
                    <li>
                        <Link href="https://www.instagram.com/centuryrealestate/" target="_blank"><Image src={`${basePath}images/icons/instagra.svg`} alt="Instagram" width={20} height={20} /></Link>
                    </li>
                    <li>
                        <Link href="https://x.com/centuryblr" target="_blank"><Image src={`${basePath}images/icons/x.svg`} alt="X" width={20} height={20} /></Link>
                    </li>
                    <li>
                        <Link href="https://www.linkedin.com/company/century-real-estate-holdings-pvt-ltd" target="_blank"><Image src={`${basePath}images/icons/linkedin.svg`} alt="Linked IN" width={20} height={20} /></Link>
                    </li>
                </ul>
            </div>
        </footer>
