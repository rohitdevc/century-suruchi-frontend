        ...
        <footer className="container max-w-full" ref={contactUsRef}>
            <div className="flex flex-col md:flex-row gap-10 md:gap-0 lg:gap-10 xl:gap-5 px-5 lg:px-10 xl:px-25 py-10 bg-[#f6f6f6] text-black">
                <div className="w-full md:w-[40%] xl:w-[30%] flex flex-col gap-5 md:pr-15 xl:pr-10 text-center items-center md:items-start md:text-left">
                    <Image src="{`process.env.NEXT_PUBLIC_IMG_URL`}images/icons/century-50-years.svg" alt="Century 50 Years" width={300} height={100} />
                ...
                <div className="w-full md:w-[60%] xl:w-[70%] flex flex-col gap-10 font-corporate-regular font-medium">
                    ...
                    <div className="flex flex-col xl:flex-row gap-5 md:gap-2 lg:gap-5 items-center md:items-left md:justify-between text-xl md:text-lg lg:text-xl">
                        <div className="flex gap-2">
                            <Image src="{`process.env.NEXT_PUBLIC_IMG_URL`}images/icons/call-icon.svg" alt="Call Icon" width={25} height={25} />
                            <Link href="tel:+918040453453">080-40453453</Link>
                        </div>
                        <div className="flex gap-2">
                            <Image src="{`process.env.NEXT_PUBLIC_IMG_URL`}images/icons/mail-icon.svg" alt="Mail Icon" width={25} height={25} />
            ...
            <div className="bg-[#9f1634] flex flex-col justify-center items-center md:items-end h-15 px-20">
                <ul className="flex gap-10">
                    <li>
                        <Link href="https://www.facebook.com/centuryrealestatebangalore/" target="_blank"><Image src="{`process.env.NEXT_PUBLIC_IMG_URL`}images/icons/facebook.svg" alt="Facebook" width={20} height={20} /></Link>
                    </li>
                    <li>
                        <Link href="https://www.instagram.com/centuryrealestate/" target="_blank"><Image src="{`process.env.NEXT_PUBLIC_IMG_URL`}images/icons/instagra.svg" alt="Instagram" width={20} height={20} /></Link>
                    </li>
                    <li>
                        <Link href="https://x.com/centuryblr" target="_blank"><Image src="{`process.env.NEXT_PUBLIC_IMG_URL`}images/icons/x.svg" alt="X" width={20} height={20} /></Link>
                    </li>
                    <li>
                        <Link href="https://www.linkedin.com/company/century-real-estate-holdings-pvt-ltd" target="_blank"><Image src="{`process.env.NEXT_PUBLIC_IMG_URL`}images/icons/linkedin.svg" alt="Linked IN" width={20} height={20} /></Link>
                    </li>
                </ul>
            </div>
        </footer>
